...
<div class="container-fluid py-2" style="max-width: 850px; margin: 0 auto;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom">
        <div>
            <h1 class="h3 fw-bold text-dark mb-1">Add New Doctor</h1>
            <p class="text-muted mb-0 small">Register a new medical professional and assign their core department</p>
        </div>
        <div>
    ...
    <div class="card border-0 shadow-sm p-4 p-md-5" style="border-radius: 14px; background: #ffffff;">
        ...
        <form action="{{ route('admin.doctors.store') }}" method="POST" class="m-0">
            @csrf
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select id="doc_dept" 
                            ...
                            required>
                        <option value="" disabled selected>Select Medical Unit</option>
            ...
            <div class="pt-4 mt-2">
                <button type="submit" class="btn btn-primary w-100 rounded-pill py-2.5 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2 btn-submit-layout">
                    <i class="bi bi-person-check-fill"></i> Save Specialist Profile
                </button>
            </div>
        </form>
