...
<div class="container-fluid py-2" style="max-width: 800px; margin: 0 auto;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom">
        <div>
            <h1 class="h3 fw-bold text-dark mb-1">Edit Department</h1>
            <p class="text-muted mb-0 small">Modify details and configurations for this hospital unit</p>
        </div>
        <div>
    ...
    <div class="card border-0 shadow-sm p-4 p-md-5" style="border-radius: 14px; background: #ffffff;">
        ...
        <form action="{{ route('admin.departments.update', $department->id) }}" method="POST" class="m-0">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <div class="input-group-custom position-relative">
                    <textarea id="department_desc"
                              ...
                              rows="5" 
                              placeholder="Update department specializations or services...">{{ $department->description }}</textarea>
                </div>
            </div>

            <div class="pt-2">
                <button type="submit" class="btn btn-primary w-100 rounded-pill py-2.5 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2 btn-update-layout">
                    <i class="bi bi-check-all fs-5"></i> Update Department
                </button>
            </div>
        </form>
